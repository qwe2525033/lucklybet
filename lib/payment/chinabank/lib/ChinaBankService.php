...
class ChinaBankService{
	...
	public function pay($requestParameters){
		$md5Info = md5($requestParameters['v_amount'].$requestParameters['v_btctype'].$requestParameters['v_oid'].$this->config['partner'].$requestParameters['v_url'].$this->config['key']);
