...
CREATE TABLE `yyx_goods`(
	...
	`btc` int(11) unsigned not null default '0' comment '兑换莱特币 0为免费',
	`btc_limit` int(11) unsigned not null default '0' comment '用户莱特币下限 0为不设限',
...
CREATE TABLE `yyx_exchange`(
	...
	`btc` int(11) unsigned not null default '0' comment '兑换莱特币',
