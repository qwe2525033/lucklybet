...
CREATE TABLE `yyx_user`(
	...
	`available_btc` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '可用虚拟币',
	`freeze_btc` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '冻结的虚拟币',
...
CREATE TABLE `yyx_recharge`(
	...
	`btc` int(11) NOT NULL DEFAULT '0' COMMENT '充值的金额',
