...
Source Database       : lucklybet

Target Server Type    : MYSQL
Target Server Version : 50547
File Encoding         : 65001

Date: 2016-06-16 14:45:54
*/

SET FOREIGN_KEY_CHECKS=0;
-- ----------------------------
-- Table structure for `yyx_address_multiaddrs`
-- ----------------------------
...
CREATE TABLE `yyx_address_multiaddrs` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `txid_address` (`address`,`txid`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yyx_address_multiaddrs
-- ----------------------------
...
INSERT INTO yyx_config VALUES ('8', '', 'basic', 'text', '', 'site_name', 'OK幸运竞猜', '0');
INSERT INTO yyx_config VALUES ('9', '', 'basic', 'text', '', 'beian', '', '0');
INSERT INTO yyx_config VALUES ('10', '', 'basic', 'text', '', 'copyright', 'Copyright © 2016 OK796 版权所有  --  管理员QQ：38504141  QQ群：415522281', '0');
INSERT INTO yyx_config VALUES ('11', '', 'btc', 'text', '', 'integral_invite', '0', '100');
INSERT INTO yyx_config VALUES ('12', '', 'btc', 'text', '', 'recharge_inviter_reward', '0', '100');
...
INSERT INTO yyx_config VALUES ('16', '', 'btc', 'text', '', 'integral_share', '0', '100');
INSERT INTO yyx_config VALUES ('17', '', 'placard', 'textarea', '', 'placard', '今日系统与庄家分比调整为，庄家全部利润的10%，系统扣除。请各位庄家朋友们注意。 ', '0');
INSERT INTO yyx_config VALUES ('18', '', 'btc', 'text', '', 'guess_tax', '0.1', '100');
INSERT INTO yyx_config VALUES ('19', '', 'btc', 'radio', '0,开启|1,关闭', 'guess_add_check', '0', '0');
INSERT INTO yyx_config VALUES ('20', '', 'btc', 'radio', '0,开启|1,关闭', 'guess_custom_add_check', '0', '0');
INSERT INTO yyx_config VALUES ('21', '', 'basic', 'radio', '0,关闭|1,开启', 'invite_open', '0', '0');
INSERT INTO yyx_config VALUES ('28', '', 'ad', 'textarea', null, 'ad', '', '0');
INSERT INTO yyx_config VALUES ('26', '', 'btc', 'text', '', 'integral_register', '0', '100');
INSERT INTO yyx_config VALUES ('27', '', 'btc', 'text', '', 'integral_user_info', '0', '100');
...
INSERT INTO yyx_config VALUES ('33', '', 'chongzhi', 'text', '', 'chongzhi_url', 'http://112.74.204.153:18055', '0');
INSERT INTO yyx_config VALUES ('34', '', 'chongzhi', 'text', '', 'chongzhi_account', 'HBCOIN_API', '0');
INSERT INTO yyx_config VALUES ('35', '', 'chongzhi', 'text', '', 'chongzhi_password', 'HbCoin_Api_pass123', '0');
INSERT INTO yyx_config VALUES ('36', '', 'chongzhi', 'text', null, 'chongzhi_querenshu', '3', '0');
INSERT INTO yyx_config VALUES ('37', '', 'chongzhi', 'text', null, 'chongzhi_shoudizhi', 'H', '0');
INSERT INTO yyx_config VALUES ('38', '', 'chongzhi', 'text', null, 'chongzhi_name', '莱特币', '0');
...
INSERT INTO yyx_guess_category VALUES ('4', '英超', '1', null, '3', '1', '1', '1', '0');
...
INSERT INTO yyx_guess_category VALUES ('14', '自定义事件', '0', '8', '2', '1', '1', '1', '0');
INSERT INTO yyx_guess_category VALUES ('15', '自定义竞猜', '14', null, '2', '1', '1', '1', '0');
...
-- ----------------------------
-- Records of yyx_manager
-- ----------------------------
INSERT INTO yyx_manager VALUES ('1', 'qwe2525033', '64b43196de9b313f47563c90bc0e3fd1', '', '1', '1', '1466057092', '1465621069');
...
INSERT INTO yyx_play_way VALUES ('8', '自定义玩法', 'YesOrNo', 'O:16:\"PlayWayParameter\":5:{s:22:\"\0PlayWayParameter\0name\";s:2:\"vd\";s:23:\"\0PlayWayParameter\0label\";s:7:\"YesOrNo\";s:29:\"\0PlayWayParameter\0description\";N;s:25:\"\0PlayWayParameter\0options\";a:0:{}s:23:\"\0PlayWayParameter\0value\";N;}', '自定义玩法,适用于自定义', '0', '1');
...
CREATE TABLE `yyx_user` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `add` (`btc_address`)
) ENGINE=MyISAM AUTO_INCREMENT=36 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yyx_user
-- ----------------------------
INSERT INTO yyx_user VALUES ('1', 'qwe2525033', '64b43196de9b313f47563c90bc0e3fd1', '595256437@qq.com', '', '', '0', '0', '0', '0', '', '', '', '', '', '', '', '', '', '', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0', '0', '0', '0', '0', '0', '0', '1', '1465700085', 'Array', '1465621359', '', null);

-- ----------------------------
-- Table structure for `yyx_user_deposit`
-- ----------------------------
...
CREATE TABLE `yyx_user_deposit` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `txid_address` (`wallet_address`,`txid`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yyx_user_deposit
-- ----------------------------
...
-- ----------------------------
-- Table structure for `yyx_user_withdraw`
-- ----------------------------
DROP TABLE IF EXISTS `yyx_user_withdraw`;
CREATE TABLE `yyx_user_withdraw` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(4) DEFAULT NULL,
  `to_wallet_address` varchar(50) DEFAULT NULL,
  `confirmations` int(4) DEFAULT NULL,
  `amount` double(19,8) DEFAULT NULL,
  `txid` varchar(150) DEFAULT NULL,
  `tx_is_ok` bit(1) DEFAULT NULL,
