				...
				<div class="filterlist">
					...
					<div class="fitem">
						...
						<ul>
							...
							<li><a <?php if($params['wealth'] == '1'){ ?>class="sel"<?php } ?> href="<?php echo url("/guess/list/?history=$params[history]&cateid=$params[cateid]&custom=$params[custom]&wealth=1&odds=$params[odds]&time=$params[time]&keyword=$params[keyword]&range=$params[range]") ?>">比特币</a></li>
