<?php include_once('E:\phpWork\lucklybet\runtime/views\./templates/default\header.php');?>
	...
	<div class="list_body">
				...
				<div class="filterlist">
					...
					<div class="fitem">
						...
						<ul>
							...
							<li><a <?php if($params['wealth'] == '1'){ ?>class="sel"<?php } ?> href="<?php echo url("/guess/list/?history=$params[history]&cateid=$params[cateid]&custom=$params[custom]&wealth=1&odds=$params[odds]&time=$params[time]&keyword=$params[keyword]&range=$params[range]") ?>">莱特币</a></li>
							...
							<li><a <?php if($params['wealth'] == '3'){ ?>class="sel"<?php } ?> href="<?php echo url("/guess/list/?history=$params[history]&cateid=$params[cateid]&custom=$params[custom]&wealth=3&odds=$params[odds]&time=$params[time]&keyword=$params[keyword]&range=$params[range]") ?>">吃喝玩乐</a></li>
						</ul>
					</div>
					<div class="fitem">
				...
				<div class="guess_list">
					...
					<div class="tab-content list_content">
						<div class="tab-pane active">
							<?php include_once('E:\phpWork\lucklybet\runtime/views\./templates/default\guess_box.php');?>
							<?php echo $pages; ?>
				        </div>
					</div>
				</div>
		...
		<div class="right">
			<?php include_once('E:\phpWork\lucklybet\runtime/views\./templates/default\notice_box.php');?>
			<!--
			<div class="ulist">
