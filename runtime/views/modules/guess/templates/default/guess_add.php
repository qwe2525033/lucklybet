...
<script type="text/javascript" src="/res/js/guess.js"></script>
<script type="text/javascript" src="/res/js/json2.js"></script>
<script type="text/javascript" src="/res/js/param.js"></script>
<style>
<!--
...
-->
	...
	<div class="post_body">
		<div class="caption">发布竞猜</div>
        <ul class="nav nav-tabs" id="post_tab">
			<!--<li><a href="/guess/add/custom/">自定义竞猜</a></li>-->
	        <li class="active"><a href="/guess/add/" onclick="return false;">发布竞猜</a></li>			
        </ul>
			...
			<div class="tab-pane active" id="t1">
				<dl class="dl-horizontal">
					...
					<dd class="c9" id="selects">
						<select style="width:120px;" class="span2" id="cateid" name="cateid" onchange="subCategorySelect(this.value, 'sub_cateid', '请选择小分类')">
						...
						<select style="display:none;width:120px;" class="span2" name="sub_cateid" id="sub_cateid" onchange="guessPointSelect(this.value, 'guess_point_id')">
						...
						<select  style="display:none;width:220px;" class="span4" name="guess_point_id" id="guess_point_id" onchange="guessPointSelected(this.value)">
							<option value="">请选择竞猜点</option>
						</select>
						&nbsp;<a href="/guess/guessPoint/add/" id="add_guess_point_button" onclick="ajaxmenu(event, this.id, 1, 0)" style="display:none;" class="btn">添加竞猜点</a>
						&nbsp;<a href="javascript:;" style="display:none;" id="load_template_button" class="btn" onclick="loadGuessAddTemplate()">确定并加载模板</a>
					</dd>
					<dd>如果您需要添加竞猜分类,请联系"添加竞猜"客服</dd>
					</dl>
