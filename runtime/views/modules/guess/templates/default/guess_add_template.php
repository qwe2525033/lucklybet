<script type="text/javascript" src="http://localhost/res/js/My97DatePicker/WdatePicker.js"></script>
...
<dd class="c9">
	 ...
	 <input type="text" class="span4" name="title" placeholder="输入竞猜标题" />
</dd>
<dt>竞猜截止时间：</dt>
<dd class="c9">
	<?php
...
<dd>
	<label class="radio inline">
		<input type="radio" name="wealth_type" value="<?php echo Guess::WEALTH_TYPE_MONEY ?>" checked="checked" onclick="GuessAddHelper.setWealthType(this.value)"/> 比特币投注
	</label>
	<!-- label class="radio inline">
