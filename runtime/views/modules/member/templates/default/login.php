...
<script type="text/javascript" src="/res/js/validation/additional-methods.min.js"></script>
...
<div id="ajaxwaitid" style="display: none;">Loading...</div>	
	...
	<div class="container reg_header"><a href="<?php echo get_config('site_url')?>"><img src="/res/images/logo.png" /></a></div>
	...
	<div class="container reg_body">
		<div class="container reg_left">
			<div class="list">
				...
				<div class="msg">
					<p class="t">多类竞猜</p>
					<p class="c">足球、财经、彩票...等主流竞猜模式，通过OK竞猜轻松勾选立刻发布。</p>
				</div>
		...
		<div class="container reg_right">
			...
			<input type="submit" class="btn loginbtn" value="登 录" /><a onclick="ajaxmenu(event, this.id, 1)" id="user_register" class="btn btn-primary regbtn"  style="margin-left:20px;margin-top:30px;" href="/member/register/">注册帐号</a>
			</form>
		</div>
		...
		<!--div class="applogin">
			...
			<div class="app">
				<a href="/member/login/app/?id=1"><img src="/res/images/sina.gif" /></a> &nbsp;&nbsp;&nbsp;&nbsp;
				<a href="/member/login/app/?id=2"><img src="/res/images/qq.gif" /></a>
			</div>
		</div-->
...
var yqcode = <?php echo $_GET['yqcode']; ?>;
if(yqcode > 0)
{
