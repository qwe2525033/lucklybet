...
<script type="text/javascript" src="http://localhost/res/js/validation/jquery.validate.min.js"></script>
<script type="text/javascript" src="http://localhost/res/js/validation/additional-methods.min.js"></script>
...
<div id="ajaxwaitid" style="display: none;">Loading...</div>	
	...
	<div class="container reg_header"><a href="<?php echo get_config('site_url')?>"><img src="http://localhost/res/images/logo.png" /></a></div>
	...
	<div class="container reg_body">
		...
		<div class="applogin">
			...
			<div class="app">
				<a href="/member/login/app/?id=1"><img src="http://localhost/res/images/sina.gif" /></a> &nbsp;&nbsp;&nbsp;&nbsp;
				<a href="/member/login/app/?id=2"><img src="http://localhost/res/images/qq.gif" /></a>
			</div>
		</div>
