<div class="userzl">
	...
	<div class="bottom">
		...
		<p>
			当前比特币：<span><?php echo $spaceUser->getAvailableBtc(); ?></span>
			<a class="btn btn-primary"  href="/member/recharge/index/" id="btc_recharge" onclick="ajaxmenu(event, this.id, 1)">充 值</a>&nbsp; &nbsp; <a class="btn btn-primary"  href="/member/btc/handsel/" id="btc_handsel" onclick="ajaxmenu(event, this.id, 1)">转 赠</a>&nbsp; &nbsp; <a class="btn btn-primary" href="/member/btc/io/" >查看明细</a>
		</p>
		<?php } ?>
	</div>
