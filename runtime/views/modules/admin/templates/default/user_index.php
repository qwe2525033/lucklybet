		            ...
		            <div class="content2">
		                ...
		                <table class="form-table">
		                    <tbody>
		                        <tr>
		                            <td width="10px">
		                                <img src="http://localhost/res/images/icon_search.gif" border="0" alt="SEARCH" />
		                            </td>
		                            <td >
		                                用户ID:
                ...
                <h3>
					...
					<tbody>
						...
						<tr>
								...
								<td align="left"><?php echo $item['available_btc']; ?>/<?php echo $item['freeze_btc']; ?></td>
