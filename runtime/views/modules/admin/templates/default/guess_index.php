		                                ...
		                                <input type="text" class="txt" name="title" value="<?php echo $request->getParameter(title) ?>" style="width:100px" />
		                                 &nbsp;
		                               	...
		                               	<select name="wealth_type">
		                               		...
		                               		<option value="1" <?php if($wealth_type == 1){ ?>selected<?php } ?>>比特币</option>
                ...
                <h3>
					...
					<tbody>
						...
						<tr>
								...
								<td align="left"><?php if($item['wealth_type'] == 1){ ?>比特币/<?php echo $item['keep_wealth']; ?><?php }elseif($item['wealth_type'] == 2){ ?>积分/<?php echo $item['keep_wealth']; ?><?php }else{ ?><?php echo $item['custom_type']; ?><?php } ?></td>
