		                                ...
		                                <input type="text" class="txt" name="title" value="<?php echo $request->getParameter(title) ?>" style="width:100px" />
		                                 &nbsp;
		                               	...
		                               	<select name="wealth_type">
		                               		...
		                               		<option value="1" <?php if($wealth_type == 1){ ?>selected<?php } ?>>莱特币</option>
		                               		<option value="2" <?php if($wealth_type == 2){ ?>selected<?php } ?>>积分</option>
		                               		<option value="3" <?php if($wealth_type == 3){ ?>selected<?php } ?>>自定义</option>
		                               	</select>										
										&nbsp;
										竞猜状态:
		                               	<select name="status">
                ...
                <h3>
					...
					<tbody>
						...
						<tr>
								...
								<td align="left"><?php if($item['wealth_type'] == 1){ ?>莱特币/<?php echo $item['keep_wealth']; ?><?php }elseif($item['wealth_type'] == 2){ ?>积分/<?php echo $item['keep_wealth']; ?><?php }else{ ?><?php echo $item['custom_type']; ?><?php } ?></td>
