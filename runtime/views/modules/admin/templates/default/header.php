...
<title><?php echo $title; ?></title> <link rel="stylesheet" href="/res/css/admin/manage.css" /> <link rel="stylesheet" href="/res/css/admin/style.css" /> <script type="text/javascript" src="/res/js/jquery/jquery-1.5.1.min.js"></script> <script type="text/javascript" src="/res/js/jquery/jquery.cookie.js"></script> <script type="text/javascript" src="/res/js/global.js"></script> <script type="text/javascript" src="/res/js/functions.js"></script>
<script type="text/javascript" src="/res/js/admin/dataList.js"></script> <script type="text/javascript" src="/res/js/tab.js"></script> <script type="text/javascript" src="/res/js/My97DatePicker/WdatePicker.js"></script> <?php echo $validateJs; ?>
<script>
	var jq = jQuery;
</script>
	...
	<div class="KK_ManageNav">
		...
		<div class="KK_ManageSear right">
			...
			<span class="s1"> <a href="/admin/index/"><img
					src="/res/images/admin/btn1.gif" style="padding-right: 0px;" /></a>
				&nbsp;&nbsp;
			</span>
		</div>
		<?php } ?>
