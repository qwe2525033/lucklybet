...
<title><?php echo $title; ?></title> <link rel="stylesheet" href="http://localhost/res/css/admin/manage.css" /> <link rel="stylesheet" href="http://localhost/res/css/admin/style.css" /> <script type="text/javascript" src="http://localhost/res/js/jquery/jquery-1.5.1.min.js"></script> <script type="text/javascript" src="http://localhost/res/js/jquery/jquery.cookie.js"></script> <script type="text/javascript" src="http://localhost/res/js/global.js"></script> <script type="text/javascript" src="http://localhost/res/js/functions.js"></script>
<script type="text/javascript" src="http://localhost/res/js/admin/dataList.js"></script> <script type="text/javascript" src="http://localhost/res/js/tab.js"></script> <script type="text/javascript" src="http://localhost/res/js/My97DatePicker/WdatePicker.js"></script> <?php echo $validateJs; ?>
<script>
	var jq = jQuery;
</script>
...
<body class="<?php echo $background; ?>" id="body_div">
	...
	<div class="KK_ManageNav">
		<div class="KK_ManageNav_link left">
			<a href="<?php echo get_config('site_url')?>">OK竞猜首页</a>
		</div>
		<?php if($manager){ ?>
		<div class="KK_ManageSear right">
			<span class="s2">您好，<?php echo $manager[name]; ?><a
				href="/admin/logout/">[退出]</a><a href="/admin/password/">[修改密码]</a></span>
			<span class="s1"> <a href="/admin/index/"><img
					src="http://localhost/res/images/admin/btn1.gif" style="padding-right: 0px;" /></a>
				&nbsp;&nbsp;
			</span>
		</div>
		<?php } ?>
