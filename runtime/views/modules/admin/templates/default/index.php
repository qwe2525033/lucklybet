            ...
            <div class="KK_ManageIndex_nav">
            	<ul class="KK_ManageIndex_list">
                    ...
                    <li id="o4" jqkey="3"><a href="/admin/config/">
                    	<dl class="pic"><img src="/res/images/admin/icon/li_bg.png" /></dl>
