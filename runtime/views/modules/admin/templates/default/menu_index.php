<?php include_once('E:\phpWork\lucklybet\runtime/views\modules/admin\templates/default\header.php');?> <script type="text/javascript" src="http://localhost/res/js/jquery/jquery.selectAll.js"></script>
	...
	<div class="KK_ManageList_mainRt_side right">
		...
		<div class="KK_ManageList_mainbox">
			<div class="KK_ManageList_mainbox_inner">
				<div class="KK_ManageList_position">当前位置
					&gt;&gt; 系统管理 &gt;&gt; 系统菜单</div>
				<h3>
					<span class="right" style="margin-right: 15px;"> <a
						href="<?php echo $act_url; ?>add/" style="float: right;">添加</a>
					</span>
				</h3>
				<form action="<?php echo $act_url; ?>batch/" method="post"><!-- EasyPHP表格组件开始 -->
